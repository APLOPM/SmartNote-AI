...
## 8.4 UX Safety Copy Baseline (TH/EN)

ข้อความความปลอดภัยที่สำคัญต้องมีทั้งภาษาไทยและอังกฤษในความหมายเดียวกัน และต้องเห็นได้ชัดก่อน action สำคัญ:

- TH: `โปรดตรวจสอบความเสี่ยงก่อนดำเนินการ`
  EN: `Please review risks before proceeding.`
- TH: `ยืนยันโดยมนุษย์ก่อนรันคำสั่งสำคัญ`
  EN: `Human confirmation is required before critical execution.`
- TH: `ดูรายละเอียดการทำงานย้อนหลังได้`
  EN: `Execution details are available for audit.`

ปุ่มหลักที่เกี่ยวกับความปลอดภัยต้องใช้คำที่สอดคล้องกัน: `ยืนยัน/ยกเลิก` และ `Confirm/Cancel` โดยห้ามใช้ถ้อยคำกำกวม.
